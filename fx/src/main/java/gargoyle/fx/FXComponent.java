...
public final class FXComponent<C, V extends Parent> {
    ...
    public Optional<URL> findResource(final Class<?> baseClass, final String resourceName, final String suffix) {
        return FXUtil.findResource(baseClass, context.getLocale(),
                context.resolveBaseName(baseClass, resourceName), suffix);
    }

    public Optional<URL> findResource(final String resourceName, final String suffix) {
        return FXUtil.findResource(context.getBaseClass(), context.getLocale(),
                context.resolveBaseName(this.baseName, resourceName), suffix);
    }

    public Optional<URL> findResource(final String suffix) {
        return FXUtil.findResource(context.getBaseClass(), context.getLocale(), baseName, suffix);
    }
    ...
    public Optional<ResourceBundle> loadResources(final Class<?> aClass) {
        return FXUtil.loadResources(context.getBaseClass(), context.getLocale(), FXUtil.resolveBaseName(aClass));
    }

    public Optional<ResourceBundle> loadResources(final String bundleName) {
        return FXUtil.loadResources(context.getBaseClass(), context.getLocale(), bundleName);
    }

    public Optional<ResourceBundle> loadResources() {
        return FXUtil.loadResources(context.getBaseClass(), context.getLocale(), baseName);
    }
    ...
    public String toString() {
        return FXUtil.format("FXComponent{baseName={baseName}, location={location}}", Map.of(
