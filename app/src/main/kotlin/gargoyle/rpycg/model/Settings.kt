...
class Settings(
    ...
    constructor(
        ...
        this.enableRollback.addListener { _: ObservableValue<out Boolean>, _: Boolean, newValue: Boolean ->
            preferences.putBoolean(
                PREF_ROLLBACK, newValue
            )
        }
        this.keyCheat.addListener { _: ObservableValue<out KeyCodeCombination>, _: KeyCodeCombination, _: KeyCodeCombination ->
            preferences.put(PREF_KEY_CHEAT, converter.toString(keyCheat))
        }
        this.keyConsole.addListener { _: ObservableValue<out KeyCodeCombination>, _: KeyCodeCombination, _: KeyCodeCombination ->
            preferences.put(PREF_KEY_CHEAT, converter.toString(keyConsole))
        }
        this.keyDeveloper.addListener { _: ObservableValue<out KeyCodeCombination>, _: KeyCodeCombination, _: KeyCodeCombination ->
            preferences.put(PREF_KEY_CHEAT, converter.toString(keyDeveloper))
        }
        this.keyWrite.addListener { _: ObservableValue<out KeyCodeCombination>, _: KeyCodeCombination, _: KeyCodeCombination ->
    ...
    fun enableCheatProperty(): Property<Boolean> = enableCheat

    fun enableConsoleProperty(): Property<Boolean> = enableConsole

    fun enableDeveloperProperty(): Property<Boolean> = enableDeveloper

    fun enableRollbackProperty(): Property<Boolean> = enableRollback

    fun enableWriteProperty(): Property<Boolean> = enableWrite

    fun getEnableCheat(): Boolean = enableCheat.value
    ...
    fun getKeyCheat(): KeyCodeCombination = keyCheat.value

    fun setKeyCheat(keyCheat: KeyCodeCombination) {
        this.keyCheat.value = keyCheat
    }

    fun getKeyConsole(): KeyCodeCombination = keyConsole.value

    fun setKeyConsole(keyConsole: KeyCodeCombination) {
        this.keyConsole.value = keyConsole
    }

    fun getKeyDeveloper(): KeyCodeCombination = keyDeveloper.value

    fun setKeyDeveloper(keyDeveloper: KeyCodeCombination) {
        this.keyDeveloper.value = keyDeveloper
    }

    fun getKeyWrite(): KeyCodeCombination = keyWrite.value

    fun setKeyWrite(keyWrite: KeyCodeCombination) {
        this.keyWrite.value = keyWrite
    }

    fun getLocaleMenu(): Locale = localeMenu.value

    fun setLocaleMenu(locale: Locale) {
        localeMenu.value = locale
    }

    fun keyCheatProperty(): Property<KeyCodeCombination> = keyCheat

    fun keyConsoleProperty(): Property<KeyCodeCombination> = keyConsole

    fun keyDeveloperProperty(): Property<KeyCodeCombination> = keyDeveloper

    fun keyWriteProperty(): Property<KeyCodeCombination> = keyWrite

    fun localeMenuProperty(): Property<Locale> = localeMenu

    companion object {
        const val PREF_KEY_CHEAT = "keyCheat"
        const val PREF_KEY_CONSOLE = "keyConsole"
        const val PREF_KEY_DEVELOPER = "keyDeveloper"
        const val PREF_KEY_WRITE = "keyWrite"
