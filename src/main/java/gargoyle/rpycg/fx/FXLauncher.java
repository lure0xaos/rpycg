...
public final class FXLauncher {
    ...
    static {
        try {
            ...
            FXLog.error(e, FXUtil.message(FXUserException.class, Locale.getDefault(),
                    FXUserException.LC_ERROR_INITIALIZATION, "log"));
        }
    }
    ...
    public static void requestRestart(final FXContext context) {
        FXCloseFlag.RESTART.set(context, fxContext -> {
            ...
            try {
                ...
                FXLog.error(e, FXUtil.message(FXUserException.class, context.getLocale(),
                        FXUserException.LC_ERROR_INITIALIZATION, "close"));
    ...
    private static void splashStart(final Class<? extends FXApplication> appClass) {
        ...
        try {
            ...
            FXLog.warn(FXUtil.message(FXUserException.class, Locale.getDefault(),
                    FXUserException.LC_ERROR_NO_RESOURCES, splashClassName));
        }
    }
