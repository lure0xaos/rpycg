...
final class FXDialogs {
    ...
    public static <R> void decorateDialog(final FXContext context, final Dialog<R> dialog,
        ...
        dialog.setDialogPane(new DecoratedDialogPane((buttonData, button) ->
                FXIntUtil.findResource(context.getBaseClass(), context.getLocale(),
                                FXUtil.resolveBaseName(Icons.class, getIconPath(buttonData)), FXConstants.EXT__IMAGES)
    ...
    public static Optional<ButtonType> error(final FXContext context, final Stage owner,
                                             ...
                                             final Map<ButtonBar.ButtonData, String> buttons) {
        if (null != ex) {
            FXLog.info(ex.getLocalizedMessage(), ex);
        }
    ...
    public static String getIconPath(final ButtonBar.ButtonData buttonData) {
        switch (buttonData) {
            case OK_DONE:
            case YES:
                return Icons.ICON_OK;
            case CANCEL_CLOSE:
            case NO:
                return Icons.ICON_CANCEL;
            default:
    ...
    private static String getString(final FXContext context,
        ...
        return FXUtil.message(FXDialogs.class, context.getLocale(), () -> defaultTitle, key);
    }
